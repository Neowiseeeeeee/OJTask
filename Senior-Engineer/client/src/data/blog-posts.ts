...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: "Tired of manually counting your OJT hours on a spreadsheet or losing your DTR? Here's the easiest way to track your internship hours as a Filipino college student — and how to make sure they're always accurate.",
    date: "June 10, 2026",
    readTime: "5 min read",
...
- **Total hours per day** — usually computed as (time out − time in) minus lunch break
- **Cumulative hours** — your running total toward your required OJT hours (typically 200–500 hours depending on your program)
- **Supervisor sign-off** — proof that your hours were verified

Most schools also require a **daily journal or scrum report** alongside the DTR — a short write-up of what you did that day.
...
3. **Your cumulative hours update automatically** — you can see your total at any time
...
- If you were absent but have an approved leave, make sure that's noted separately — it typically doesn't count toward your required hours.
...
If you want to try OJTask, it's free and takes about two minutes to set up. Your supervisor creates a space, shares a code, and you're in.
  ...
  },
  {
    ...
    category: "For Students",
    content: `
## "What's a Daily Scrum?" — A Question Almost Every OJT Intern Asks
...
1. **What did you do today?** — A short description of the tasks you worked on during your OJT hours
2. **What will you do tomorrow?** — What you plan to work on next
3. **Is anything blocking you?** — Any problem, question, or resource you need that's preventing you from making progress

That's it. Most daily scrum reports for OJT take two to three minutes to write. The goal isn't to write an essay — it's to give your supervisor a clear picture of your day without needing a meeting.
...
**For you:** Writing a daily scrum forces you to reflect on what you actually accomplished. Over time, you can look back and see your own progress. It also makes writing your final OJT report or terminal report much easier — you already have a day-by-day record.
...
**Date:** [Date]
**OJT Hours Today:** [e.g., 8:00 AM – 5:00 PM]
...
The form is simple. The discipline is what matters.
  ...
  },
  {
    ...
    description: "A comprehensive checklist of every document, form, and requirement you'll need to complete your OJT as a Philippine college student — and tips for keeping them all organized.",
    date: "June 14, 2026",
    readTime: "6 min read",
    category: "For Students",
    content: `
...
- [ ] **Terminal Report / Final OJT Report** — A detailed written report summarizing your entire OJT experience, learnings, and accomplishments. Usually 10–30 pages depending on your school's format.
